...
namespace FIX50
{
  ...
  public:
    ...
    public:
      static FIX::message_order const & getOrder() {
        static int const data[] = {54,37,198,11,526,66,453,1,660,581,81,575,576,578,579,821,15,376,377,528,529,582,40,18,483,336,625,943,12,13,479,497,157,230,158,159,738,920,921,922,238,237,118,119,120,155,156,77,752,518,232,136,825,826,591,70,78,1093,1072,1057,1009,1005,1006,1007,83,1008,1016};
        static FIX::message_order const order(data, 67);
        return order;
      };
