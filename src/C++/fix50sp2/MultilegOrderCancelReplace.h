...
namespace FIX50SP2
{
  ...
  public:
    ...
    public:
      static FIX::message_order const & getOrder() {
        static int const data[] = {79,661,736,467,948,80};
    ...
    public:
      static FIX::message_order const & getOrder() {
        static int const data[] = {600,601,602,603,607,608,609,764,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,615,616,617,618,619,620,621,622,623,624,556,740,739,955,956,999,1001,1017,566,1212,1358,1420,1224,1421,1422,1436,1440,687,690,683,670,564,565,539,654,587,588,685,1366,1379,1381,1383,1384,675};
        static FIX::message_order const order(data, 70);
        return order;
      };
