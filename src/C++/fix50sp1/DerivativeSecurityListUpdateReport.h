  ...
  public:
    ...
    public:
      static FIX::message_order const & getOrder() {
        static int const data[] = {1324,55,65,48,22,460,461,167,762,200,541,224,225,239,226,227,228,255,543,470,471,472,240,202,947,206,231,223,207,106,348,349,107,350,351,691,667,875,876,873,874,965,966,1049,967,968,969,970,971,996,997,1079,1151,1146,1147,1227,1191,1192,1193,1194,1195,1196,1198,1199,1200,201,1244,1242,1197,668,869,1305,1221,1230,1240,15,555,58,354,355,292};
        static FIX::message_order const order(data, 81);
        return order;
      };
      NoRelatedSym () : FIX::Group(146,1324,getOrder()) {}
